...
public final class DataSize implements Comparable<DataSize>, Serializable {
    ...
    public static DataSize parse(CharSequence text, @Nullable DataUnit defaultUnit) {
        ...
        try {
            Matcher matcher = DataSizeUtils.PATTERN.matcher(StringUtils.trim(text.toString()));
            Preconditions.checkArgument(matcher.matches(), "Does not match data size pattern");
