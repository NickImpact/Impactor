...
@GeneratedEvent(
        source = net.impactdev.impactor.api.platform.events.lifecycle.LifecycleEvent.ServerStarting.class,
        version = "8.0.0"
)
final class LifecycleEvent_ServerStarting_Impl implements net.impactdev.impactor.api.platform.events.lifecycle.LifecycleEvent.ServerStarting {
    private Platform platform;

    private Server server;

    LifecycleEvent_ServerStarting_Impl(final Platform platform, final Server server) {
