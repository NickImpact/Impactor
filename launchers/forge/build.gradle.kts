...
dependencies {
    ...
    modImplementation("ca.landonjw.gooeylibs:forge:3.0.0-1.19.4-SNAPSHOT@jar")
...
tasks {
    shadowJar {
        val mapped = "loom_mappings_1_19_4_layered_hash_40359_v2_forge_1_19_4_45_1_0_forge"
        dependencies {
