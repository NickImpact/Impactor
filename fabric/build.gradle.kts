...
dependencies {
    ...
    val FABRIC_API_VERSION = rootProject.property("fabric-api").toString()
    setOf(
        "fabric-api-base",
...
tasks {
    shadowJar {
        dependencies {
            ...
            include(dependency("loom_mappings_1_18_2_layered_hash_40359_v2.ca.landonjw.gooeylibs:fabric:3.0.0-1.18.2-SNAPSHOT"))
...
//        relocate ("nonapi.io.github.classgraph", "net.impactdev.impactor.relocations.classgraph.nonapi")
    ...
    remapJar {
        ...
        val fabric = rootProject.property("fabric-loader")
